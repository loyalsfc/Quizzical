    ...
    return(
        <ul className='flex flex-col md:flex-row gap-6 items-center text-grey-100'>
            ...
            {user ? (<li className='profile cursor-pointer flex items-center text-green-100 relative'>
                ...
                <div className='dropdown bg-white py-1 rounded-md shadow absolute top-full'>
                    <ul>
                        <li className='hover:bg-gray-100 border-b py-1 px-5'>Profile</li>
                        <li className='hover:bg-gray-100 border-b py-1 px-5'>Leaderboard</li>
                        <li className='hover:bg-gray-100 border-b py-1 px-5'>Settings</li>
                        <li onClick={logOut} className='hover:bg-gray-100 pt-1 px-5'>Logout</li>
                    </ul>
                </div>
            </li>
            ):(
