...
function SubjectsModal() {
    ...
    return (
        <div className='h-screen w-full fixed top-0 left-0 bg-black/[0.5] flex items-center justify-center'>
            <div className='relative bg-white w-[80%] py-[62px]'>
                <svg className='absolute right-[18px] top-[18px]' width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex flex-wrap gap-[30px] pl-[80px] pr-[29px]'>
                    {categoriesItem}
                </div>
            </div>
